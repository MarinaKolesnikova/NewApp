                        ...
                        else
                        {
                            ...
                            if (table.Rows.Count > 0)
                            {
                                foreach (DataRow ro in table.Rows)
                                {
                                    ...
                                    meetList[iterator].Add(temMeet);
                                    message = "Нагадуємо, що сьогодні " + temMeet.dateM.ToString("dd-MM-yyyy HH:mm") + " ВІДБУДЕТЬСЯ " + temMeet.title + " З " + temMeet.participants + " У " + temMeet.place + " Нотатки: " + temMeet.notes;
